...
@Component({
  selector: 'app-geo-location-common',
  templateUrl: './geo-location-common.component.html'
})
export class GeoLocationCommonComponent implements OnInit {
...
MapAdddressToshow:any;
callMethod(mapAddress:any){
  this.searchAddress=mapAddress;
  this.codeAddress();
}
