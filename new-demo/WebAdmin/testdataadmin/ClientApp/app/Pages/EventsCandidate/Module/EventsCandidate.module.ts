...
import { EventsCandidateRoutes } from './EventsCandidate.routes';
import { EventsCandidateComponent } from '../EventsCandidate.Component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild(EventsCandidateRoutes),
...
export class EventsCandidateModule { }
