...
import { EventsGalleryRoutes } from './EventsGallery.routes';
import { EventsGalleryComponent } from '../EventsGallery.Component';
...
@NgModule({
  imports: [
    ...
    RouterModule.forChild(EventsGalleryRoutes),
...
export class EventsGalleryModule { }
